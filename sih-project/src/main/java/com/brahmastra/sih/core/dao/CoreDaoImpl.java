...
public class CoreDaoImpl<T extends CoreDomain> extends HibernateDaoSupport
		implements CoreDao<T> {

	private final Class<T> persistentClass;
	private static final Log log = LogFactory.getLog(CoreDaoImpl.class);
	 ...
	 */
	public CoreDaoImpl(Class<T> persistentClass) {
		super();
