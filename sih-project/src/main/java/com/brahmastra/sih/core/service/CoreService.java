package com.brahmastra.sih.core.service;
...
public interface CoreService<T extends CoreDomain> {
	T insert(T transientInstance) throws Exception;
	...
	PaginatedResult<T> paginateAll(int... rowStartIdxAndCount);
